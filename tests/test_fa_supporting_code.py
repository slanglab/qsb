...
def test_get_tok():
    sent = load_sentence("tests/basic_verb.txt.json")
...
def test_is_negated():
    sent = load_sentence("tests/simple_negation.txt.json")
...
def test_is_negated2():
    sent = load_sentence("tests/simple_negation2.txt.json")
...
def test_lexical_runs():
    jdoc = load_sentence("tests/simple_negation2.txt.json")
