...
\textsc{random} {\small (lower bound) }&{\small 0.653}&{\small 0.377}& {\small 0.7} \\
\textsc{ablated} {\small (edge only) }&{\small 0.827}&{\small 0.669}&{\small 4.4}\\
\textsc{vertex addition}$_{NN}$& {\small 0.873}& {\small 0.728}& {\small 4836.5} {\tiny  (CPU)} \\ \midrule 
\textsc{ilp}&{\small 0.852}& {\small 0.756}&{\small 56.7}\\
\textsc{vertex addition}$_{LR}$ & \small 0.881 & {\small 0.745}& {\small 4.8} \\
\end{tabular}
