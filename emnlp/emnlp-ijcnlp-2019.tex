...
Thanks to Javier Burroni and Nick Eubank for extensive help with optimizing and measuring performance of Python code. Thanks to Jeffrey Flanigan, Katie Keith and the UMass NLP reading group for suggesting edits and changes which clarified our work. 
