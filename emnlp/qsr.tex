...
\caption{Additive compression in 5 timesteps, from left to right. $C$ is shown with black shading, $F$ is shown with grey shading and $v= \pi(F)$ is shown as a square. The final compression is $\{1,2,3,5\}$. At step 1, $C \gets Q = \{1,2\}$. }
