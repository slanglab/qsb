...
Additive compression assumes a boolean relevance model, which defines some initial compression, containing the user's query term. Many search interfaces (Figure \ref{f:qf}) such constrained compressions.
...
\begin{tabular}{lrrl}
\centering
Approach & F1 & SLOR &  Latency {, \small sec. / sentence}  \\ \hline
%ILP &  {\small 0.854}   &  {\small 0.776 }  & {\small $\mu=$ .115} ({\small $ \sigma=.074$}) \\
%Additive &  {\small \textbf{0.871}}  & {\small \textbf{0.800} }& {\small $\mu=$ 300} ({\small $ \sigma=X$}) \\
%Rand.  &  {\small 0.690}  & { X }& {\small $\mu=$ 300} ({\small $ \sigma=X$}) \\
ILP&{\small 0.000 }&{\small 0.000 }&{\small 0.111 }( {\small 0.065 })\\
Rand.&{\small 0.489 }&{\small nan }&{\small 0.001 }( {\small 0.001 })\\
Additive&{\small 0.873 }&{\small nan }&{\small 0.010 }( {\small 0.004 })\\
\end{tabular}
