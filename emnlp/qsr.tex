...
Finally, compression methods based on LSTM taggers \cite{filippova2015sentence} cannot currently enforce lexical or length requirements. Future work might address this limitation with constrained generation techniques \cite{D16-1140,N18-1119,D18-1443}.
