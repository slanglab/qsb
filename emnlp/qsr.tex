...
At test time, we use a model of oracle decisions to decide if $v$ should be added to $C$.  We model each oracle decision $y_i \in \{0,1\}$ with binary logistic regression.
