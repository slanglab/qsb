...
This additive approach can construct constrained compressions (\S\ref{s:formal}) in linear time (\S\ref{s:costs}), making it well-suited to interactive search applications (Figure \ref{f:qf}) which must provide rapid feedback during browsing.
