...
Random {\small (lower bound)} &{\small 0.493}  &{\small 0.093}&{\small 0.001} ({\small 0.001})\\
ILP&{\small 0.000}&{\small 0.000}&{\small 0.105} ({\small 0.053})\\
Additive {\small (edge only) } &\textbf{\small 0.845}&\textbf{\small 1.153}&\textbf{\small 0.008} (\textbf{\small 0.003})\\
\textbf{Additive}&\textbf{\small 0.883}&\textbf{\small 1.153}&\textbf{\small 0.008} (\textbf{\small 0.003})\\\end{tabular}
