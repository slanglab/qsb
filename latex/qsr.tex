...
We note that our constrained compression experiment passes the oracle compression rate (pct. of tokens retained) as a parameter to each compression system. Prior work shows that automatic performance of compression systems is closely tied to their compression rate \cite{napoles2011evaluating}. Accordingly, we observe that both the ILP and the transition-based compressor achieve higher automatic evaluations in the constrained task.
