...
search engines, concept map browsers and new forms of exploratory textual interfaces, where length and lexical constraints are paramount. \ahcomment{Cite hearst, IR book, falke, marchioni. examples.} Compression methods which achieve high predictive accuracy on gold training data are simply not useful for practitioners who must include query terms in shortened sentences; or scale compressions to a desktop interface or mobile phone.

This work presents a new, transition-based method which leverages the predictive power of neural methods, while accommodating length and lexical requirements. We compare our method, \textbf{iterative deletion} to traditional ILP-based techniques, which also give a user such control.
