...
\subsection{Constrained compression with iterative deletion}
...
There are two free parameters in the iterative deletion approach: (1) how to decide if a particular subtree may be deleted and (2) what order should subtrees be considered for deletion. In this study, we consider each of these two questions in depth.



\subsection{Unconstrained compression with LSTM taggers}
