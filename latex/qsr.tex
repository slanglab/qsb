...
As a check on the readability of the compressions produced by each system, we measure their well-formedness using an automated metric which has been shown to predict with human judgements of grammatical acceptability. Specifically, we employ the SLOR function defined by \citet{lau2015unsupervised}, who showed that this metric correlates with human acceptability judgements. \ahcomment{CITE MANN} (The appendix contains additional details of our implementation of SLOR. \ahcomment{LM}) Our iterative deletion technique achieves a SLOR score of \ahcomment{TODO}. The ILP-based approach achieves a SLOR score of \ahcomment{TODO}.

 \ahcomment{3-gm LM and report inline}.
