...
We thus present a new stateful method for query-focused compression. \textbf{Our approach is theoretically and empirically faster than ILP-based techniques, and more accurately reconstructs gold standard compressions.}
