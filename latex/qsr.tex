...
These settings violate the traditional assumptions of the sentence compression problem. In place of the traditional goal of retaining the most ``important'' from source sentences for display in a summary, in such settings compression systems must instead $(i)$ contain a users' query term $(ii)$ remain readable or coherent and  $(iii)$ fit in the space allotted on screen.
