...
\centering
Approach & F1  \\ \hline
Human acceptability supervision         &  \ahcomment{TODO, maybe. Roll in w/ nn i think}        \\
F and A (2013)    & .79           \\
C and L (2008)    & \ahcomment{TODO, maybe}        \\
...
\ahcomment{todo: actually write up notes below}
...
\ahcomment{How will we deal with semantics? Brendan email about subsective adjectives ellie pavlik work. Right now we just use the gold data for this I guess}
