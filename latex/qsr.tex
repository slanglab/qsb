...
We thus present a new stateful method for query-focused compression. \textbf{Our approach is theoretically and empirically faster than ILP-based techniques, and achieves higher F1 scores.}
...
\textsc{vertex addition} & \small 0.881 &\textbf{\small 1.149}&\textbf{\small 5.2}\\
