...
Our method better reconstructs known-good compressions, and achieves higher automatic readability scores (Table \ref{t:results}). We evaluate the significance of each difference with bootstrap sampling \cite{D12-1091}; each is significant {\small $(p < 10^{-3})$}. 
...
and interpret the $c$'s length (in characters) as the character budget $b$.
This defines our test set of 6,827 $(s,q,b,c)$ tuples of sentences, constraints, and 
