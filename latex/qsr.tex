...
The markup is the deterministic (rather than learned) output of a markup function $m(V,v,o,s)=\bm{x}$, which inserts three sets of matched, inline bracket symbols into $s$, the original sequence of tokens in the sentence. The bracket symbols represent the following information:
