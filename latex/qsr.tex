...
We achieve a validation accuracy of 0.945\% on a set of 100,000 held-out oracle operations. We find that increasing the size of the training data further does not increase validation accuracy. 
